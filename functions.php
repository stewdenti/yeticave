 ...
 * @return array
 */
function getLotsByCategoryId($category_id)
{
 ...
 * @return array|bool
 */
function getLotByKey($key="id", $value="")
{
 ...
 * @return bool
 */
function  isMakeBindAllowed($lot_id, $user_id)
{
