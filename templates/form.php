...
function printValidItemClass($item, $name)
{
    if (isset($item[$name])) {
        echo $item[$name];
    }
...
<form class="form form--add-lot container <?php if ($error):?>form--invalid<?php endif; ?>" action="/add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
    ...
    <div class="form__container-two">
        <div class="form__item <?php printInvalidItemClass($error, 'lot-name'); ?>">
            ...
            <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?php printValidItemClass($lot_item, 'lot-name');?>">
        ...
        <div class="form__item <?php printInvalidItemClass($error, 'category'); ?>">
            ...
            <select id="category" name="category">
                ...
                <?php if (isset($lot_item['category']) && $lot_item['category']-1==$key) {?>
    ...
    <div class="form__item form__item--wide <?php printInvalidItemClass($error, 'message'); ?>">
        ...
        <textarea id="message" name="message" placeholder="Напишите описание лота" ><?php printValidItemClass($lot_item, 'message');?></textarea>
    ...
    <div class="form__container-three">
        <div class="form__item form__item--small <?php printInvalidItemClass($error, 'price'); ?>">
            ...
            <input id="price" type="number" name="price" placeholder="0" value="<?php printValidItemClass($lot_item, 'price');?>">
        ...
        <div class="form__item form__item--small <?php printInvalidItemClass($error, 'lot-step'); ?>">
            ...
            <input id="lot-step" type="number" name="lot-step" placeholder="0" value="<?php printValidItemClass($lot_item, 'lot-step');?>">
        ...
        <div class="form__item <?php printInvalidItemClass($error, 'lot-date'); ?>">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="lot-date" placeholder="20.05.2017" value="<?php printValidItemClass($lot_item, 'lot-date');?>">
